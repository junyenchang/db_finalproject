<?php
    ...
    echo "目前此項比賽報名名額已滿，無法報名~~~";
        ...
        echo "<a href='badminton.html'>未成功跳轉頁面請點擊此</a>";
        header('refresh:32; url = badminton.html');
    }
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "SELECT * FROM badminton WHERE user_id ='$user_id'";
            $result=mysqli_query($conn,$sql);
            if (mysqli_num_rows($result)==0 ){  //資料庫沒有相同的帳號
                ...
                $sql_fin = "INSERT INTO badminton ( NUM, user_id, playername, id) VALUES('$NUM','$user_id','$playername','$id')";
